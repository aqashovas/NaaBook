...
namespace NaaBook.Areas.Manage.Controllers
{
    ...
    public class SettingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Headerimg,Mail,Address,Facebook,Twitter,Instagram")] Setting setting)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Headerimg,Mail,Address,Facebook,Twitter,Instagram")] Setting setting)
        {
            if (ModelState.IsValid)
            {
