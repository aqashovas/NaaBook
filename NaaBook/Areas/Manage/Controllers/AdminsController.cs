...
namespace NaaBook.Areas.Manage.Controllers
{
    ...
    public class AdminsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FullName,Username,Password")] Admin admin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FullName,Username,Password")] Admin admin)
        {
            if (ModelState.IsValid)
            {
